...
{
    [Header("포탈 설정")]
    public string sceneToLoad;      // 이동할 씬의 이름 (Build Settings에 등록되어 있어야 함)
    ...
    // 다음 씬에서 참조할 수 있도록 정적(static) 변수에 저장합니다.
    ...
    void Update()
    {
        ...
        // 지정된 위치에서 반경 내에 플레이어 레이어를 가진 오브젝트가 있는지 체크
